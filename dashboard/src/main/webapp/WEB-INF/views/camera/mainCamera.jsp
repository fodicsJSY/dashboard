							...
							<div class="data">
								<ul>
									<li class="today-part8" >
										<div class="todayTXT todayHuman" style="margin-right:0px; width: 40%;" onclick="location.href='main_camera_part1_human.html'">
										...
										<div id="Human_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">											
										</div>								
									</li>
									<li class="today-part8" >
										<div class="todayTXT todayCar"  style="margin-right:0px; width: 40%;" onclick="location.href='main_camera_part1_Vehicle.html'">
											<p class="todayIMG"><img src="img/icon_titleCar.png"></p>
										...
										<div id="Car_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">											
										</div>
									</li>
									<li class="today-part8" >
										<div class="todayTXT todayFace"  style="margin-right:0px; width: 40%;" onclick="location.href='main_camera_part1_face.html'">
										...
										<div id="Face_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">											
										</div>
									</li>
									<li class="today-part8" >
										<div class="todayTXT todayCounting"  style="margin-right:0px; width: 40%;" onclick="location.href='main_camera_part1_counting.html'">
										...
										<div id="Counting_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">											
										</div>
									</li>
									<li class="today-part8" >
										<div class="todayTXT todayIntrusion"  style="margin-right:0px; width: 40%;" onclick="location.href='main_camera_part1_Invasion.html'">
										...
										<div id="Invasion_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">											
										</div>										
									</li>									
									<li class="today-part8" >
										<div class="todayTXT todayLoitering"  style="margin-right:0px; width: 40%;" onclick="location.href='main_camera_part1_loitering.html'">
										...
										<div id="Loitering_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">											
										</div>
									</li>
									<li class="today-part8">
										<div class="todayTXT todayLPR"  style="margin-right:0px; width: 40%;">
											<p class="todayIMG"><img src="img/icon_titleLPR.png"></p>
											<p class="todayTitle color-LPR">차량 번호 인식</p>
											<p class="amount">0</p>
											<p class="contrast">전일대비 <span class="lower">0</span></p>
										</div>
										<div id="LPR_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">										
										</div>
									</li>
									<li class="today-part8">
										<div class="todayTXT todayParking"  style="margin-right:0px; width: 40%;">
											<p class="todayIMG"><img src="img/icon_titleNoParking.png"></p>
											<p class="todayTitle color-Parking">불법 주·정차</p>
											<p class="amount">0</p>
											<p class="contrast">전일대비 <span class="lower">0</span></p>
										</div>
										<div id="Parking_grid_area" style="width: 60%; float: left;" onclick="location.href='sub_camera.html'">									
										</div>
									</li>
								</ul>
