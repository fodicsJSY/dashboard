							...
							<div class="data">
								...
								<div class="todayData" style = "width:58%; height:396px; margin-top:20px; float:left;">     
									...
									<div class="grid-container" style = "padding-left:3%; padding-top:13%; width:98%; height:100px; " id = "cloth_wnd"> 	
										...
										<div class="grid-item_header"><img src="./img/icon_titleMale.png" style = "margin-top: -5px; margin-left: 60px; float:left;"><div style = "margin-top: 3px; text-align: left;">&nbsp;&nbsp;남자</div></div>
										<div class="grid-item_header"><img src="./img/icon_titleFemale.png" style = "margin-top: -5px; margin-left: 60px; float:left;"><div style = "margin-top: 3px; text-align: left;">&nbsp;&nbsp;여성</div></div>
